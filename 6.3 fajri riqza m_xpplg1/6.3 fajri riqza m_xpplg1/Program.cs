...
namespace _6._3_fajri_riqza_m_xpplg1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Masuka nama siswa ke-1:   ");
            nama[0] = Console.ReadLine();
            Console.Write("Masukan nilai siswa ke-1: ");
            nilai[0] = int.Parse(Console.ReadLine());

            Console.Write("Masuka nama siswa ke-2:   ");
            nama[1] = Console.ReadLine();
            Console.Write("Masukan nilai siswa ke-2: ");
            nilai[1] =Convert.ToInt32(Console.ReadLine());

            Console.Write("Masuka nama siswa ke-3:   ");
            nama[2] = Console.ReadLine();
            Console.Write("Masukan nilai siswa ke-3: ");
